...
import * as SearchQueryDtos from '../discovery/dto/search-query.dto'
...
export class SearchController {
  ...
  async search(@Query() query: SearchQueryDtos.SearchQueryDto) {
  ...
  async suggestions(
    @Query() query: SearchQueryDtos.SearchSuggestionsQueryDto,
