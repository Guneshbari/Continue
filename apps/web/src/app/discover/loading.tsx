...
export default function DiscoverLoading() {
  return (
    <main
      className="site-container discovery-layout-container"
      ...
      <div className="discovery-page-hero">
        <div className="discovery-page-hero__meta" style={{ width: '100%' }}>
          <Skeleton
            ...
            style={{ width: '160px', height: '0.875rem', marginBottom: '0.75rem' }}
          />
          <h1
            className="discovery-page-hero__title"
          ...
          <Skeleton
            className="skeleton-line"
            style={{ width: '80%', height: '1.25rem', marginTop: '1rem', marginBottom: '0.5rem' }}
          />
        ...
        <aside className="discovery-sidebar" aria-hidden="true">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <div>
              <Skeleton
                className="skeleton-line"
                style={{ width: '80px', height: '1rem', marginBottom: '0.75rem' }}
              />
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {[1, 2, 3, 4].map((i) => (
                  <Skeleton
                    key={i}
                    className="skeleton-line"
                    style={{ width: '100%', height: '2.25rem', borderRadius: 'var(--radius-sm)' }}
                  />
                ))}
              </div>
            </div>
            <div>
              <Skeleton
                className="skeleton-line"
                style={{ width: '100px', height: '1rem', marginBottom: '0.75rem' }}
              />
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                {[1, 2, 3].map((i) => (
                  <Skeleton
            ...
            <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              {[1, 2, 3, 4].map((i) => (
                <Skeleton
                  key={i}
                  className="skeleton-line"
                  style={{ width: '140px', height: '2.5rem', borderRadius: 'var(--radius-md)' }}
                />
              ))}
            </div>
          </div>
