        ...
        {[1, 2].map((s) => (
          <div key={s} className="discover-dashboard-section" style={{ marginBottom: '4rem' }}>
            <div
              ...
              style={{ width: '200px', height: '1.5rem', marginBottom: '1.5rem' }}
            />
  ...
  return (
    <div className="discover-dashboard">
      {sections.map((sec) => (
        <section
          key={sec.href}
          className="discover-dashboard-section"
          aria-labelledby={`title-${sec.title.replace(/\s+/g, '-')}`}
        >
      ...
      <div className="discovery-page-hero">
        <div className="discovery-page-hero__meta">
          ...
          <p className="discovery-page-hero__desc">
            Scale deep into Continue’s gaming catalog. Browse trending hits, highly acclaimed
            releases, and curated editorial selections.
          </p>
        </div>
      </div>
