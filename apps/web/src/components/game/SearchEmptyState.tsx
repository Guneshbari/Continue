...
export function SearchEmptyState({ query, onClear }: SearchEmptyStateProps) {
  return (
    <div
      ...
      style={{ padding: '4rem 2rem', marginInline: 'auto', maxWidth: '480px' }}
    >
      <div
        style={{
          display: 'flex',
      ...
      <p className="games-grid-empty__sub" style={{ margin: '0.5rem 0 1.5rem' }}>
        We couldn&rsquo;t find any matches. Try adjusting your spelling or searching for a different
        title, genre, or developer.
      </p>
      {onClear && (
