...
export const FEATURED_GAMES: GameDetail[] = [
  {
    ...
    avgRating: 9.4,
    ratingCount: 84201,
    genres: [{ id: 'g1', slug: 'action-rpg', name: 'Action RPG' }, { id: 'g2', slug: 'open-world', name: 'Open World' }],
    platforms: [{ id: 'p1', slug: 'pc', name: 'PC' }, { id: 'p2', slug: 'ps5', name: 'PS5' }],
  ...
  },
  {
    ...
    avgRating: 9.6,
    ratingCount: 61500,
    genres: [{ id: 'g3', slug: 'rpg', name: 'RPG' }, { id: 'g4', slug: 'strategy', name: 'Strategy' }],
  ...
  },
  {
    ...
    avgRating: 9.1,
    ratingCount: 21000,
    genres: [{ id: 'g5', slug: 'rogue-like', name: 'Rogue-like' }, { id: 'g1', slug: 'action-rpg', name: 'Action RPG' }],
    platforms: [{ id: 'p1', slug: 'pc', name: 'PC' }],
    tags: [],
  },
]

export const TRENDING_GAMES: GameSummary[] = FEATURED_GAMES.map(({ tags: _t, description: _d, bannerUrl: _b, developer: _dev, publisher: _pub, ...rest }) => rest)
...
export const COMMUNITY_COLLECTIONS: SeedCollection[] = [
  {
    ...
    description: 'The definitive path through the genre — ranked by accessibility for newcomers and depth for veterans.',
  ...
  },
  {
    ...
    description: 'Games that redefined what a role-playing experience can be in the last five years.',
  ...
  },
  {
    ...
    description: 'Small teams, giant vision. Each game on this list proves that budget is no barrier to brilliance.',
